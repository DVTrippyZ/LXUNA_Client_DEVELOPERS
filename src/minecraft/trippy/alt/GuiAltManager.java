...
extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        Gui.drawRectF(50.0f, 33.0f, width - 50, height - 50, -16777216);
        GL11.glPushMatrix();
        ...
        for (Alt alt2 : AltManager.registry) {
            ...
            if (alt2 == this.selectedAlt) {
                if (this.isMouseOverAlt(par1, par2, y2 - this.offset) && Mouse.isButtonDown(0)) {
                    Gui.drawRectF(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, -2142943931);
                } else if (this.isMouseOverAlt(par1, par2, y2 - this.offset)) {
                    Gui.drawRectF(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, -2142088622);
                } else {
                    Gui.drawRectF(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, -2144259791);
                }
            } else if (this.isMouseOverAlt(par1, par2, y2 - this.offset) && Mouse.isButtonDown(0)) {
                Gui.drawRectF(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, -16777216);
            } else if (this.isMouseOverAlt(par1, par2, y2 - this.offset)) {
                Gui.drawRectF(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, -16777216);
            }
